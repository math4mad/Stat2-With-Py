# /// notebook
# # ch03 · Boy vs Girl Growth Rate
#
# Grouped linear regression of Weight ~ Age by Sex.
# Separate and combined fit lines.
# ///
...
def _(Stat2Table, mo):
    ...
    desc = Stat2Table(
        page=314,
        name="Kids198",
        question="boy-girl-growth-rate",
        feature=["Age", "Weight", "Sex"],
    )
...
def _(gdf, sexes, models, plt, add_border, np):
    """3. Combined plot: both groups with fit lines."""
